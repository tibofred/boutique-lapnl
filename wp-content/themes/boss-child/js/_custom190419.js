jQuery( document ).ready(function($) {
	...
	var a = ".products li.post-13720.product";
	if($(a).length) {
		$(a).append("<div style='text-align:center; color:#FF0000; font-weight:bold; font-size:18px;'>Disponible bientôt</div>")
	}

	/*$( "#header-menu .menu-item.menu-item-has-children" ).on( "click", function(e) {
		e.stopPropagation();
		$(this).find('.open-submenu').click();
		return false;
	});*/

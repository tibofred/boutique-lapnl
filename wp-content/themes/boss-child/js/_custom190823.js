jQuery( document ).ready(function($) {
	...
	if($('.lesson.post-13277').length) {
		$('.lesson.post-13277').after("<div class='title_module'>Module 1</div>");
	}	
	if($('.lesson.post-16376').length) {
		$('.lesson.post-16376').after("<div class='title_module'>Module 2</div>");
	}	
	if($('.lesson.post-16325').length) {
		$('.lesson.post-16325').after("<div class='title_module'>Module 3</div>");
	}	
	if($('.lesson.post-16417').length) {
		$('.lesson.post-16417').after("<div class='title_module'>Module 4</div>");
	}


	if($('#lesson_list-13277').length) {
		$('#lesson_list-13277').after("<div class='title_module'>Module 1</div>");
	}	
	if($('#lesson_list-16376').length) {
		$('#lesson_list-16376').after("<div class='title_module'>Module 2</div>");
	}	
	if($('#lesson_list-16325').length) {
		$('#lesson_list-16325').after("<div class='title_module'>Module 3</div>");
	}	
	if($('#lesson_list-16417').length) {
		$('#lesson_list-16417').after("<div class='title_module'>Module 4</div>");
	}	

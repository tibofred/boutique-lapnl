...
<div class="formations_lap2">
    <div class="flp3">
        <?php echo do_shortcode('[student course_id="1824"][ld_course_list mycourses="true" show_thumbnail="false" tag="Base en ligne" order="ASC" orderby="order"][/student]');  ?>
        <?php echo do_shortcode('[visitor course_id="1824"][products ids="12715"  orderby="date" order="DESC"][/visitor]');?>
    </div>
    
    <div class="flp3">
        <?php echo do_shortcode('[student course_id="13281"][ld_course_list mycourses="true" show_thumbnail="false" tag="Praticien PNL en ligne" order="ASC" orderby="order"][/student]');?>
        <?php echo do_shortcode('[visitor course_id="13281"][products ids="15994"  orderby="date" order="DESC"][/visitor]');?>
    </div>    

    <div class="flp3">
        <?php echo do_shortcode('[student course_id="16100"][ld_course_list mycourses="true" show_thumbnail="false" tag="Maître Praticien en PNL en ligne" order="ASC" orderby="order"][/student]');?>
        <?php echo do_shortcode('[visitor course_id="16100"][products ids="16002"  orderby="date" order="DESC"][/visitor]');?>
    </div>
</div>
...
<div class="formations_lap2">
    ...
    <div class="flp3">
        <?php echo do_shortcode('[student course_id="13269"][ld_course_list mycourses="true" show_thumbnail="false" tag="Hypnose Ericksonienne de Base" order="ASC" orderby="order"][/student]');  ?>
        <?php echo do_shortcode('[visitor course_id="13269"][products ids="13721"  orderby="date" order="DESC"][/visitor]');?>
    </div>    
    
    <div class="flp3">
        <?php echo do_shortcode('[student course_id="17100"][ld_course_list mycourses="true" show_thumbnail="false" tag="Hypnose Praticien" order="ASC" orderby="order"][/student]');  ?>
        <?php echo do_shortcode('[visitor course_id="17100"][products ids="17231"  orderby="date" order="DESC"][/visitor]');?>
    </div>
</div>
<h4 id="cat_ema" style="font-size: 24px; color: #002D4F; border-bottom:1px solid #002D4F">EMA / AMO ™</h4>
<div class="formations_lap2">   
    <div class="flp3">
        <?php echo do_shortcode('[student course_id="13257"][ld_course_list mycourses="true" show_thumbnail="false" tag="EMA / AMO™ 1" order="ASC" orderby="order"][/student]');  ?>
        <?php echo do_shortcode('[visitor course_id="13257"][products ids="13720"  orderby="date" order="DESC"][/visitor]');?>
    </div>  
</div>
<h4 id="cat_aura" style="font-size: 24px; color: #002D4F; border-bottom:1px solid #002D4F">Aura Vision&#x2122; - Lecture d'Aura</h4>
<div class="formations_lap2">    
    <div class="flp3">
        <?php echo do_shortcode('[student course_id="17435"][ld_course_list mycourses="true" show_thumbnail="false" tag="aura vision" order="ASC" orderby="order"][/student]');  ?>
        <?php echo do_shortcode('[visitor course_id="17435"][products ids="17432"  orderby="date" order="DESC"][/visitor]');?>
    </div>  
</div>

    ...
    <?php endif; ?>
		...
		if ( is_user_logged_in() ) {
            ...
            if ( is_user_logged_in() ) {
				...
				echo "<div style='color: #FFF; padding:25px 25px; text-align: center; font-size:15px;'>Bonjour, ".$first_name1." ".$last_name1."</div>";
            }
            ?>
		...
		<?php } else { ?>
            ...
            <?php echo boss_cart_icon_html(); ?>
            <div class="table-cell"><a href="<?php echo wp_login_url(); ?>" class="login"><?php _e( 'Login', 'boss' ); ?></a></div>

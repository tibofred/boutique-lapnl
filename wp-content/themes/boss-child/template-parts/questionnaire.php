<?php
/**
 * Template Name: Questionnaire Formation en ligne
...
<div class="page-full-width">
	<div id="primary" class="site-content">
			<div id="content" role="main">
				<br/><br/><br/>
<iframe class="frame_prinscript" src="https://forms.zohopublic.com/idcominternational/form/Questionnairedvaluationdelaformation/formperma/QU1xA89Y8hRMz-SFjJU9Hf-4OSaJqdLnNZUexxGUPT0"></iframe>
</div>
</div>
</div>

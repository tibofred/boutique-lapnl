                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <div class="entry-content">
                        ...
                        ?>
                                                ...
                                                <?php if( have_rows('materiels') ): ?>

                            <ul class="matriel">

                            <?php while( have_rows('materiels') ): the_row(); 
                                ...
                                <li>
                                        ...
                                        <a href="<?php echo $fichier; ?>" target="_blank"><img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt'] ?>" class="cd-img"/></a>

			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_activity_can_favorite() ) : ?>
					...
					<?php if ( !bp_get_activity_is_favorite() ) : ?>
						...
						<a href="<?php bp_activity_favorite_link(); ?>" class="button fa fa-star-o fav bp-secondary-action" title="<?php esc_attr_e( 'Mark as Favorite', 'boss' ); ?>">
					...
					<?php else : ?>
						...
						<a href="<?php bp_activity_unfavorite_link(); ?>" class="button fa fa-star unfav bp-secondary-action" title="<?php esc_attr_e( 'Remove Favorite', 'boss' ); ?>">
						<?php if ( $b_wall && 0 < $like_count ) : ?>
							<span class="likes-count"><?php echo $like_count; ?></span>
						<?php endif; ?>
						</a>

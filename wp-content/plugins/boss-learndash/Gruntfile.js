...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        cssmin: {
            ...
            target: {
                files: {
                    'assets/css/learndash-rtl.min.css': 'assets/css/learndash-rtl.css',
                    'assets/css/learndash.min.css': 'assets/css/learndash.css'
                }
            }
        },
        /*
        ...
        uglify: {
            ...
            frontend: {
                files: {
                    'assets/js/learndash.min.js': [ 'assets/js/learndash.js' ],
                }
            },
        },
        /*
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'boss-learndash', 'buddypress', 'bbpress', 'learndash', 'woocommerce' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'boss-learndash.pot', // Name of the POT file.

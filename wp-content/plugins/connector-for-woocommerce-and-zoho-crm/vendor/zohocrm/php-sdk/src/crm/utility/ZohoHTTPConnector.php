...
class ZohoHTTPConnector
{
    ...
    public function fireRequest()
    {
		...
		// Following function call was added
		// woocommerce-and-zoho-crm-connector-pro\PP_Zoho_API_v1.class.php
		curl_setopt_array($curl_pointer, array(
			CURLOPT_SSL_VERIFYPEER => !get_option('pp_wczc_no_ssl_verify'),
			CURLOPT_CAINFO => ABSPATH.'wp-includes/certificates/ca-bundle.crt'
		));

...
if (!class_exists("crmformsZohoApi")) {
    ...
    class zcfaccountApi {
        ...
        public function zcfFormDatainsert($modulename, $methodname, $authkey, $xmlData = "", $extraParams = "") {
               ...
               $this->zcf_SubmitLog($responseresultjson);
        ...
        public function zcf_SubmitLog($responseresultjson){
            global $wpdb;
            $status = $responseresultjson['data'][0]['code'];
            $desc = serialize($responseresultjson['data'][0]);
            $wpdb->insert( 'zcf_submitlogs' , array( 'crmsubmitlogStatus' => $status,'crmsubmitlogDescribtion'=>$desc) );
        }
